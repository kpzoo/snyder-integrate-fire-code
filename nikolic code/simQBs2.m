% This script aims to reproduce the functionality of the Nikolic code in a
% single main file with no gui and the ability to simulate multiple photons
function QBout = simQBs2(runs, biosimname, saveLoc)

% Assumptions and modifications
% - allows control of save folder structure
% - altered parameters to match the default values of param_set
% - there were commented sections in the original parameter set and
% cascade dynamics sections of gui_singleQB_multi
% - removed all commented code related to activation variables
...
% clearvars -except s t Iset runs fcut tstep tMset PLCmaxset PLCtotset...
%     DAGmaxset Ntrpmaxset Camaxset Cafreemaxset biosimname totruns...
%     runs len biosimroot
% save([biosimname 'Raw.mat']);
...
clearvars -except QBout biosimname totruns runs len biosimroot saveLoc
