% Altered parameters to match the default values of param_set from the
% original code

% Note: there were commented sections in the original parameter set and
...
function QBout = simQBs(runs, biosimname)
...
clearvars -except QBout biosimname totruns runs len biosimroot
